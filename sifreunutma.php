  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li><a href="index.php">Anasayfaya Git</a></li>
        </ul>
      </div>
    </div>
  </nav>
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title text-center form-title" style="color:white;">Şifremi unuttum</h4>
        </div>
        <div class="modal-body padtrbl">
          <div class="login-box-body">
            <p class="login-box-msg">Birkaç saniyenizi ayırın.</p>
            <div class="form-group">
              <form  id="loginForm" action="sifreunutma2.php" method="post" >
                <div class="form-group has-feedback">
                  <input class="form-control" placeholder="Kullanıcı Adı"  type="text" autocomplete="off" name="sukuladi"/>
                  <span class="glyphicon glyphicon-user form-control-feedback" style="background-color: rgb(230,230,230);"></span>
                </div>
                <div class="form-group has-feedback">
                  <input class="form-control" placeholder="Yeni Şifre"  type="text" autocomplete="off" name="susifre"/>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-green btn-block btn-flat">Şifreyi Yenile</button>
                  </div>
                </div>
              </form>
            </div>
