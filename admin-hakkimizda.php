...
?>
        ...
        <form action="admin-hakkimizda.php" method="post">
        <div class="col-md-12">
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            <div class="form-group">
            <textarea class="form-control" name="aciklama" rows="15"  placeholder="Hakkımızda Yazısı"></textarea>
            </div>
          </div>
...
$sqlekle="insert into hakkimizda (aciklama) values ('$aciklama')";
